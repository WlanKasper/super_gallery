...
<body>
    <main>
        <form action="../php/auth/registration.php" onsubmit="return validation(this);" name="form_registration"
            method="post">
            <input type="text" name="input_login" id="_email" maxlength="20" placeholder="LOGIN">
            <input type="password" name="input_psw" id="_psw" maxlength="10" placeholder="PASSWORD" value="">
            <input type="password" name="input_psw_conf" id="_psw_conf" maxlength="10" placeholder="PASSWORD" value="">
            <button type="submit">
                <h4>
                    SIGN UP
                </h4>
